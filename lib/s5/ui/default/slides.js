...
// starting the jquery replacement
...
// setup Controls to work
function setupControls() {
  $("a#show-notes").click(function(event){
    createNotesWindow();
  ...
  // controls hover
  $("div#controlsOuter").mouseover(function(){
    $("div#controls").show();
  });
  $("div#controlsOuter").mouseout(function(){
    if ( ! controlsOpen || ! controlsTempOpen ) {
      $("div#controls").hide();
    } 
  });
};
